...
export class EhrController {
  ...
  @ApiResponse({
    status: 201,
    description: 'clinical entry successfully created.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'clinical entry successfylly updated',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'medical history succesfully archived.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'medical history succesfully unarchived.',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'medical history successfully got.',
  })
  async getMedicalHistoryComplete(
